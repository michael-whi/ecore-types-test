export namespace Ecore {
    ...
    interface Resource extends EObject {
        ...
        parse: (data: EObject, loader: Function) => any;//test me
        getEObject: (fragment: String) => null | EObject;//fragment: string? test me
        remove: () =>void;
        rev: string; //need test
        load: (res: any) => void;
        to: () => any;
    }
    interface EPackage extends EObject {
        getEPackage: (nsURI: string)=> EPackage; //test me
        register: (ePackage: EPackage)=> void;
        ePackages: ()=>EPackage[];//test me
        elements: (type:EObject)=>EObject[];//test me
